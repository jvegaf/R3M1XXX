...
// RM68140_DRIVER #define ST7796_DRIVER #define SSD1963_480_DRIVER #define
// SSD1963_800_DRIVER #define SSD1963_800ALT_DRIVER #define ILI9225_DRIVER
...
// portrait orientation #define TFT_WIDTH  80 #define TFT_WIDTH  128 #define
// TFT_WIDTH  240 // ST7789 240 x 240 and 240 x 320 #define TFT_HEIGHT 160
...
// offset) #define ST7735_REDTAB #define ST7735_BLACKTAB #define
// ST7735_REDTAB160x80   // For 160 x 80 display with 24 pixel offset
...
// Display CS        to RP2040 pin D20 (can use another pin if desired, or GND,
// see below) Display GND       to RP2040 pin GND (0V) Display VCC       to
// RP2040 5V or 3.3V (5v if display has a 5V to 3.3V regulator fitted)
//
